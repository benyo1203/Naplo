 ...
 * 
 */
@WebServiceClient(name = "MNBArfolyamServiceSoapImpl", targetNamespace = "http://tempuri.org/", wsdlLocation = "https://www.mnb.hu/arfolyamok.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://www.mnb.hu/arfolyamok.asmx?wsdl");
